...
public class ReadWrite {
	...
	public String[] getQueryArgs(Resource vivoIndiv, String vivoPersonEmplId, String vivoPersonNetId) throws IOException  {
		...
		String HRISRDFBaseQuery = ReadQueryString(MainClass.fileQryPath + "qStrOnePersonHRISRDF.txt");
		String HRISRDFnetIdQuery = ReadQueryString(MainClass.fileQryPath + "qStrOnePersonHRISNetIDRDF.txt");
