...
public class ProcessNewVivoPerson extends IteratorMethods {
	...
	public Model processNewVIVOperson(OntResource newHRISIndiv, String personId) throws Exception {
		...
		String NEWHRISRDFBaseQuery = rw.ReadQueryString(MainClass.fileQryPath + "qStrNewPersonHRISRDF.txt");
			...
			try {
				...
				if (prettyTitle != null) {
				    ...
				    if (positionType != null) {
				    	...
				    	logger.debug("getPositionType is *NOT* changing " + HRISPersonJobTitle + " to " + positionType);
						// incorrectly inserting position into person. Was this supposed to attach to position? 
